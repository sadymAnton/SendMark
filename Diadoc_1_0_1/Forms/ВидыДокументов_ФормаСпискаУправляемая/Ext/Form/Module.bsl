...
Процедура ОбновитьСписокНаСервере()
	...
	Список = ОбработкаОбъект().ЭДО_СправочникМенеджер_ПолучитьСписокЭлементов("ВидыДокументов");
...
Процедура ОткрытьФормуЭлементаДляРедактированияИлиДобавления(ЭтоДобавление=Ложь)
	...
	ОсновнаяФорма().Модуль_Платформа().ОткрытьФормуЭлементаДляРедактированияИлиДобавления("ВидыДокументов_ФормаЭлементаУправляемая", СсылкаНаЭлемент);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия="Диадок_Сохранение_ВидыЭлектронныхДокументов" Тогда
		ОбновитьСписокНаСервере();
	КонецЕсли;
