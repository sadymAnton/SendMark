...
Функция ПолучитьЗаполненныйОбъектДокумента1С(Параметры)
	...
	Если ЭтоНакладнаяИлиАкт(Параметры.ДокументДД) Тогда
		...
		Результат = ЗагрузитьЭлектроннуюНакладнуюИлиАктВПТУ(Параметры.ДокументДД);
	...
	ИначеЕсли ЭтоСчетФактура(Параметры.ДокументДД) Тогда
		...
		Если ЭтоСчетФактураПоАгентскойСхеме(Параметры.ДокументДД, Параметры.ПакетДД) Тогда
			
			ЗагрузитьЭлектронныйСчетФактуруВПТУ(Параметры.ДокументДД);
			Результат = ЗагрузитьЭлектронныйСчетФактуруВСчетФактуру(Параметры.ДокументДД);
...
Процедура ВыполнитьПроверкуГотовностиКОбработке(ДокументДД)
	...
	ПроверитьНаЗаполненность(Контрагент1СПоДокументу(ДокументДД), "Контрагент для документа не определен");
...
Функция ЭтоСчетФактураПоАгентскойСхеме(ДокументДД, ПакетДД)
	
	Если ЭтоСчетФактураВВалюте(ДокументДД) И ВПакетеОтсутствуютАктИНакладная(ПакетДД) Тогда
		Возврат Истина;
	КонецЕсли;
...
Функция ЭтоСчетФактураВВалюте(ДокументДД)
КонецФункции

Функция ВПакетеОтсутствуютАктИНакладная(ДокументДД)
КонецФункции
...
Функция ЗагрузитьЭлектроннуюНакладнуюИлиАктВПТУ(ДокументДД)
	
	
	
КонецФункции

Функция ЗагрузитьЭлектронныйСчетФактуруВСчетФактуру(ДокументДД)
КонецФункции

Функция ЗагрузитьЭлектронныйСчетФактуруВПТУ(ДокументДД)
КонецФункции
