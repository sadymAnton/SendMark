...
//{ Если возможно несколько договоров, то запоминаем для постобработки	
	...
	Если массивВозможныхДоговоров.Количество() > 0 и ПараметрыДляГрупповойПостОбработки <> Неопределено Тогда
		ПараметрыДляГрупповойПостОбработки.Вставить("НеобходимаОбработка", Истина);
